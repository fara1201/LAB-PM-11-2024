    ...
    private void getUserDetails(int userId) {
        ...
        call.enqueue(new Callback<UserResponse>() {
            ...
            public void onResponse(Call<UserResponse> call, Response<UserResponse> response) {
                handler.post(() -> {
                    progressBar.setVisibility(View.GONE); //klo misal respon berhasil brrti dia tampilkan data pengguna yg valid
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (desiredUser != null) { // u Tampilkan data pengguna yg ingin ditemukan
                            ...
                            Picasso.get().load(avatarUrl).into(avatarImageView);  //u unduh gambar dari url ke image

                            avatarImageView.setVisibility(View.VISIBLE);
                            nameTextView.setVisibility(View.VISIBLE);
                            emailTextView.setVisibility(View.VISIBLE);
                        } else {
                            Toast.makeText(DetailActivity.this, "User not found", Toast.LENGTH_SHORT).show(); //klo misal pengguna yg diinginkan tdk ditemukan
                        }
                    } else {
                        Toast.makeText(DetailActivity.this, "Failed to retrieve user data", Toast.LENGTH_SHORT).show(); //klo responnya gagal
                    }
                });
            }
