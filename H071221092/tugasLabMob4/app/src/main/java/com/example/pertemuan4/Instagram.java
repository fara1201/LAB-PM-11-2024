...
public class Instagram implements Parcelable {
    ...
    //constructur newpostingan
    public Instagram(String username, String aeris, String konten, int aeris1, Uri selectedImageUri) {
        this.username = username;
        this.name = aeris;
        this.desc = konten;
        this.fotoProfile = aeris1;
